...
struct KeychainItem {
	...
	static var currentUserIdentifier: String {
		do {
			let storedIdentifier = try KeychainItem(service: "Triplenine-Holdings.Modular-Test-App", account: "userIdentifier").readItem()
	...
	static func deleteUserIdentifierFromKeychain() {
		do {
			try KeychainItem(service: "Triplenine-Holdings.Modular-Test-App", account: "userIdentifier").deleteItem()
		} catch {
